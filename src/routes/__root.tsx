  ...
  head: () => ({
    meta: [
      ...
      { title: "Vote Ayo — Ayolela Vena for House Secretary & Treasurer" },
      {
        name: "description",
        content:
          "Ayolela Vena for Chris Hani Residence House Secretary & Treasurer. Service. Accountability. Integrity. Earning your trust through action.",
      },
      { property: "og:title", content: "Vote Ayo — Ayolela Vena" },
      {
        property: "og:description",
        content:
          "Service. Accountability. Integrity. Ayolela Vena for Chris Hani Residence House Secretary & Treasurer.",
      },
